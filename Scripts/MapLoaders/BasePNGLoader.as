...
const SColor color_purple_spawn(0xff9e3abb);
...
// Kag Heroes Objects
//NAND
const SColor color_barracks_red(0xff746C6C);
const SColor color_barracks_blue(0xff756C6C);

const SColor color_archerbarracks_blue(0xff65A46C);
const SColor color_archerbarracks_red(0xff66A46C);


const SColor color_portal_blue(0xff4d067b);
const SColor color_portal_red(0xff390958);
const SColor color_portal_marker(0xff12031b);

const SColor color_towerbottom_blue(0xff981bbc);
const SColor color_towerbottom_red(0xff991bbc);
const SColor color_towertop_blue(0xff961bbc);
const SColor color_towertop_red(0xff9c1bbc);
...
class PNGLoader
{
	...
	if (pixel == color_tile_ground) {
		...
		else if (pixel == color_archerbarracks_red)
		{
			spawnBlob( map, "archerbarracks", offset, 1);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_archerbarracks_blue)
		{
			spawnBlob( map, "archerbarracks", offset, 0);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_portal_blue)
		{
		
			spawnBlob( map, "portal", offset, 0);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_portal_red)
		{
			spawnBlob( map, "portal", offset, 1);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_portal_marker) {
			AddMarker( map, offset, "portal marker" );
		}
		else if (pixel == color_towerbottom_blue)
		{
		
			spawnBlob( map, "wartowerbottom", offset, 0);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_towerbottom_red)
		{
		
			spawnBlob( map, "wartowerbottom", offset, 1);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_towertop_blue)
		{
		
			spawnBlob( map, "wartowertop", offset, 0);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_towertop_red)
		{
		
			spawnBlob( map, "wartowertop", offset, 1);
			offsets[autotile_offset].push_back( offset );
		}
		else if (pixel == color_neutral_trader)
		{
