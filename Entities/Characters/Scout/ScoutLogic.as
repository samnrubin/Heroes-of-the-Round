...
void ManageGrapple( CBlob@ this, ScoutInfo@ archer )
{
...
void ManageBow( CBlob@ this, ScoutInfo@ archer, RunnerMoveVars@ moveVars )
{
	CSprite@ sprite = this.getSprite();	
...
bool grappleHitMap(ScoutInfo@ archer, CMap@ map, const f32 dist = 16.0f)
{
...
bool shouldReleaseGrapple(CBlob@ this, ScoutInfo@ archer, CMap@ map)
{
