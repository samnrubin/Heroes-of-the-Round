...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sudden gib"), "Use this to make all enemies in a 8 tile radius instantly turn into a pile of gibs.", params );
}
...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	if (cmd == this.getCommandID("sudden gib"))
	{
		...
		if (caller !is null)
		{
			...
			CBlob@[] blobsInRadius;	   
			if (this.getMap().getBlobsInRadius( this.getPosition(), t(8), @blobsInRadius )) 
			{
