...
void SetupScrolls(CRules@ this)
{
	...
	{
		ScrollDef def;
		def.name = "Scroll of Hall Teleport";
		def.scrollFrame = FactoryFrame::magic_midas;
		def.scripts.push_back( "ScrollHall.as" );
		all.scrolls.set( "telehall", def );
	}

	{
		ScrollDef def;
		def.name = "Scroll of Base Teleport";
		def.scrollFrame = FactoryFrame::magic_midas;
		def.scripts.push_back( "ScrollHome.as" );
		all.scrolls.set( "telehome", def );
	}
...
//	copyFrom( all.scrolls, "saw", medium.scrolls );
	...
	copyFrom( all.scrolls, "telehall", super.scrolls );
